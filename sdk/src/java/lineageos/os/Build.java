...
public class Build {
    ...
    public static final String MIST_VERSION = getString("ro.mist.version.base");

    /** A build ID string meant for displaying to the user */
    public static final String MIST_DISPLAY_VERSION = getString("ro.mist.version_display");
